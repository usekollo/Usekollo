...
import { ChevronDown, Clock, ExternalLink, Search, SlidersHorizontal } from "lucide-react";
...
export default function ActivityPage() {
	...
	const filtered = useMemo(() => {
		if (!data) return [];
		return statusFilter === "all" ? data.activity : data.activity.filter((item) => item.status === statusFilter);
	}, [data, statusFilter]);
	...
	const changeStatus = (value: ActivityStatus | "all") => {
